...
const STORY = [
  ...
  { type: "date", value: "7월 19일 (일) — 하계수양회" },
  { type: "say", text: "뜨거웠던 하계수양회. 대강당을 가득 채운 찬양과 선포되는 말씀이 %NAME%의 마음을 뜨겁게 채우고 있었다." },
  { type: "bg", value: "bg-retreat-out" },
  { type: "date", value: "7월 20일 (월) — 하계수양회 마지막 날" },
  ...
  { type: "waitAll",
    key: "sermon_done",
    title: "✝️ TV 화면을 봐 주세요",
    sub: "말씀이 끝나면 진행자가 다음으로 진행합니다." },
